...
export class MeasurementId {
  ...
  private ensureValueIsDefined(value: string): void {
    if (value === null || value === undefined || value === "") {
      throw new InvalidArgumentError("The measurement id value must be defined");
    }
  }
  ...
  private ensureValueIsUUID(value: string): void {
    ...
    if (!uuidRegex.test(value)) {
      throw new InvalidArgumentError("The measurement id value does not comply with the UUID format");
    }
  }
}