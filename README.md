# README - AquaFlowAPISensorsReadings
...
```bash
git clone https://github.com/Kevinjr2912/AquaFlowAPISensorsReadings.git
cd AquaFlowAPISensorsReadings
```
...
The application will be available at http://localhost:3000 (or the port assigned in the environment variables).